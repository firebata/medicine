$(function () {
    ...
    $('#user_LoginEmail,#user_hasLoginEmail,#user_hasLoginPassword,#user_LoginPassword').focus(function () {
        $('#noZzLinksAccount_beError').hide();
        $('#hasZzLinksAccount_EmailBeError').hide();
        $('#hasZzLinksAccount_beError').hide();
    ...
    $('#user_bindForm').validate({
        ...
        messages: {
            email: {
                required: "请输入登录邮箱地址",
                email: "请输入有效的邮箱地址，如：vivi@zzlinks.cn"
            },
            password: {
                required: "请输入密码",
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.success) {
                        ...
                        /*密码错误和页面超时的提示信息*/
                        $('#hasZzLinksAccount_beError').html(result.msg).show();
                    } else if (result.success == false && result.code == 100) {
                        //邮箱未注册提示的错误
                        $('#hasZzLinksAccount_EmailBeError').html(result.msg).show();
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.success) {
                        ...
                        $('#noZzLinksAccount_beError').html(result.msg).show();
                    } else if (result.success == false && result.code == 100) {
                        //邮箱未注册提示的错误
                        //$('#noZzLinksAccount_beError').html(result.msg).show(); 
                    } else if (result.success == false && result.code == 1) {
