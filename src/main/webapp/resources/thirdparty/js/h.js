(function () {
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    h = ["{"];
                    for (k in d)if (Object.prototype.hasOwnProperty.call(d, k))switch (g = d[k], typeof g) {
                        case "undefined":
                        case "unknown":
                        case "function":
                            break;
    ...
    (function () {
        ...
        (function () {
            if (!d)if (d = l, "complete" === document.readyState)a.b = l; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
                f, n), window.addEventListener("load", a, n); else if (document.attachEvent) {
    ...
    var aa = navigator.cookieEnabled, ba = navigator.javaEnabled(), ha = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLanguage || "", ia = window.screen.width + "x" + window.screen.height, ja = window.screen.colorDepth;
    var O = 0, P = Math.round(+new Date / 1E3), Q = "https:" == document.location.protocol ? "https:" : "http:", R = "cc cf ci ck cl cm cp cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api tt u".split(" ");
    ...
    V.prototype = {
        getData: function (a) {
            ...
            try {
                y(a, b, {domain: la(), path: ma(), f: d}), d ? G(a, b, d) : w(a, b)
            } catch (e) {
            }
        }, k: function (a) {
            if (N(a, "Array")) {
    ...
    function oa() {
        ...
        if (a)for (var a = a.split(","), b = 0, d = a.length; b < d; b++)B(Q + "//" + decodeURIComponent(a[b]).replace(/^https?:\/\//, ""), function (a) {
            X(a)
        })
    }
    ...
    function ka(a) {
        try {
            ...
            if (document.referrer) {
                var u = n;
                if (Y(document.referrer) && Y(document.location.href))u = l; else var pa = v(document.referrer), u = Z(pa || "", document.location.hostname);
            ...
            0 == a.a.nv ? oa() : X(".*");
            if ("" != c.icon) {
                var r, s = c.icon.split("|"), S = "http://tongji.baidu.com/hm-web/welcome/ico?s=" + c.id, T = ("http:" == Q ? "http://eiv" : "https://bs") + ".baidu.com" + s[0] + "." + s[1];
                switch (s[1]) {
                    case "swf":
                        var da = s[2], ea = s[3], J = "s=" + S, z = "HolmesIcon" + P;
            ...
            var K = document.location.hash.substring(1), ua = RegExp(c.id), va = -1 < document.referrer.indexOf("baidu.com") ?
                l : n;
            if (K && ua.test(K) && va) {
            ...
            if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
                ...
                var M = window._hmt;
                if (M &&
                    M.length)for (var t = 0, xa = M.length; t < xa; t++)a.k(M[t]);
                window._hmt = a.p
            }
