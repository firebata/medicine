    ...
    <div id="container">
        <div class="user_bindSidebar">
            <dl id="user_sideBarmenu" class="user_sideBarmenu">
                <dt>
                <h3>帐号设置</h3></dt>
                <dd><a class="hover" href="#">账号信息</a></dd>
                <dd><a href="/pwd">修改密码</a></dd>
            </dl>
        </div>
            ...
            <dl class="c_section">
                ...
                <dd id="pad">
                    <ul class="user_noModify">
                        <li>当前登录帐号：<span>${usr.name!}</span></li>
                        <input type="text" placeholder="请输入称谓" value="${usr.name!}" name="name" id="name"/>
                        <input type="text" placeholder="请输入联系邮箱" value="${usr.email!}" name="email" id="email"/>
                        <span class="error" style="display:none;" id="beError"></span>
                    </ul>
                    <input type="button" value="保存" id="upUsrInfo" class="btn_32">
                </dd>
            </dl>
        </div>
...
<script type="text/javascript" src="/resources/zlstatic/js/sys/acmg.js"></script>
